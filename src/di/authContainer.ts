...
import {
    GithubOAuthProvider,
    GoogleOAuthProvider,
    IGithubOAuthProvider,
    IGoogleOAuthProvider
} from "../modules/oauth.provider";
...
container.register<IGoogleOAuthProvider>("IGoogleOAuthProvider", { useClass: GoogleOAuthProvider });
container.register<IGithubOAuthProvider>("IGithubOAuthProvider", { useClass: GithubOAuthProvider });

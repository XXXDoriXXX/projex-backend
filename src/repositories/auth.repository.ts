...
export interface IAuthRepository {
    createUser(username: string, email: string, passwordHash: string, avatar: string): Promise<User>;
...
export class AuthRepository implements IAuthRepository {
    async createUser(username: string, email: string, passwordHash: string, avatar:string): Promise<User> {
